...
- In this simulation studies, all methods converge.
...
When number of signals is 1, two objectives from two replicates are computed. 
```{r}
...
When number of signals is 2, two objectives from two replicates are computed. 
```{r}
...
When number of signals is 3, two objectives from two replicates are computed. 
```{r}
...
When number of signals is 4, two objectives from two replicates are computed. 
```{r}
...
When number of signals is 5, two objectives from two replicates are computed. 
```{r}
